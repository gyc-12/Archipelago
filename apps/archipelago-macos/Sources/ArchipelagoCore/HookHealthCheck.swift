...
public enum HookHealthCheck {
    ...
    public static func checkClaude(
        ...
        // 3. Check manifest
        if fileManager.fileExists(atPath: settingsPath),
           hasArchipelagoHooks(in: settingsURL, fileManager: fileManager) {
    ...
    public static func checkCodex(
        ...
        // 3. Check manifest
        if fileManager.fileExists(atPath: hooksPath),
           hasArchipelagoHooks(in: hooksURL, fileManager: fileManager) {
    ...
    public static func checkOpenCode(
        ...
        let pluginFileURL = pluginsDir.appendingPathComponent(OpenCodePluginInstallationManager.pluginFileName)
    ...
    private static func hasArchipelagoHooks(in url: URL, fileManager: FileManager) -> Bool {
