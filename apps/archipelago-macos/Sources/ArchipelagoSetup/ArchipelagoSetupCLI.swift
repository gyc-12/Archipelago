...
private struct SetupCommand {
    ...
    private func install() throws {
        ...
        print("Installed Archipelago Codex hooks.")
    ...
    private func uninstall() throws {
        ...
        print("Removed Archipelago Codex hooks.")
        print("Codex dir: \(status.codexDirectory.path)")
    ...
    private func installClaude() throws {
        ...
        print("Installed Archipelago Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        print("Hooks binary: \(hooksBinary.path)")
        if status.hasClaudeIslandHooks {
            print("Note: claude-island hooks are still present alongside Archipelago hooks.")
        }
    }
    ...
    private func uninstallClaude() throws {
        ...
        print("Removed Archipelago Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        if status.hasClaudeIslandHooks {
    ...
    private func installKimi() throws {
        ...
        print("Installed Archipelago Kimi hooks.")
    ...
    private func uninstallKimi() throws {
        ...
        print("Removed Archipelago Kimi hooks.")
        print("Kimi dir: \(status.kimiDirectory.path)")
...
private enum SetupError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .usage:
            """
            Usage:
              swift run ArchipelagoSetup install [--hooks-binary /abs/path/to/ArchipelagoHooks] [--codex-dir /abs/path/to/.codex]
              swift run ArchipelagoSetup uninstall [--codex-dir /abs/path/to/.codex]
              swift run ArchipelagoSetup status [--hooks-binary /abs/path/to/ArchipelagoHooks] [--codex-dir /abs/path/to/.codex]
              swift run ArchipelagoSetup installClaude [--hooks-binary /abs/path/to/ArchipelagoHooks] [--claude-dir /abs/path/to/.claude]
              swift run ArchipelagoSetup uninstallClaude [--claude-dir /abs/path/to/.claude]
              swift run ArchipelagoSetup statusClaude [--hooks-binary /abs/path/to/ArchipelagoHooks] [--claude-dir /abs/path/to/.claude]
              swift run ArchipelagoSetup installKimi [--hooks-binary /abs/path/to/ArchipelagoHooks] [--kimi-dir /abs/path/to/.kimi]
              swift run ArchipelagoSetup uninstallKimi [--kimi-dir /abs/path/to/.kimi]
              swift run ArchipelagoSetup statusKimi [--hooks-binary /abs/path/to/ArchipelagoHooks] [--kimi-dir /abs/path/to/.kimi]
            """
