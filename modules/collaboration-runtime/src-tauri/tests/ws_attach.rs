...
use archipelago_runtime_lib::acp::types::{AcpEvent, EventEnvelope};
use archipelago_runtime_lib::app_state::AppState;
use archipelago_runtime_lib::db::test_helpers::fresh_in_memory_db;
use archipelago_runtime_lib::models::agent::AgentType;
use archipelago_runtime_lib::web::event_bridge::emit_with_state;
use archipelago_runtime_lib::web::router::build_router;
use archipelago_runtime_lib::web::shutdown::ShutdownSignal;
...
fn ws_auth_protocol(token: &str) -> String {
    ...
    format!("archipelago-events, archipelago-token.{encoded}")
}
