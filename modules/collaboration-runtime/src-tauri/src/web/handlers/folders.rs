...
use crate::commands::groups::{self as group_commands, GroupDeletedPayload, GROUP_DELETED_EVENT};
use crate::models::*;
...
pub async fn remove_folder_from_workspace(
    ...
    let deleted_group_ids =
        group_commands::delete_groups_by_folder_core(&state.db, params.folder_id).await?;
