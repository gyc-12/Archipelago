...
mod m20260603_000001_group_chat;
mod m20260603_000002_group_chat_schema_patch;
pub struct Migrator;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20260603_000001_group_chat::Migration),
            Box::new(m20260603_000002_group_chat_schema_patch::Migration),
        ]
    }
}
