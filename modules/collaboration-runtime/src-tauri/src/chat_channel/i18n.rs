...
pub fn help_title(lang: Lang) -> &'static str {
    match lang {
        Lang::ZhCn => "Archipelago Bot 帮助",
        Lang::ZhTw => "Archipelago Bot 幫助",
        Lang::Ja => "Archipelago Bot ヘルプ",
        Lang::Ko => "Archipelago Bot 도움말",
        Lang::Es => "Ayuda de Archipelago Bot",
        Lang::De => "Archipelago Bot Hilfe",
        Lang::Fr => "Aide Archipelago Bot",
        Lang::Pt => "Ajuda do Archipelago Bot",
        Lang::Ar => "مساعدة Archipelago Bot",
        Lang::En => "Archipelago Bot Help",
    }
}
