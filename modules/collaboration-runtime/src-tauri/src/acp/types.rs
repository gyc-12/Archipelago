...
pub enum AcpEvent {
    ...
    /// Archipelago resolved an Island group collaboration request before sending
    /// the prompt to the orchestrator. Consumers use this as a visible plan
    /// cue; actual execution still flows through delegate_to_agent.
    GroupCollaborationPlan {
        group_id: i32,
        group_name: String,
        primary_agent_id: i32,
        requested_mentions: Vec<String>,
        invalid_mentions: Vec<String>,
        members: Vec<GroupCollaborationMemberInfo>,
    },
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub struct GroupCollaborationMemberInfo {
    pub agent_id: i32,
