...
/// Per-agent defaults applied when archipelago-mcp spawns a subagent on behalf of a
...
///
/// `parent_connection_id` is the archipelago-internal ACP connection UUID for the
