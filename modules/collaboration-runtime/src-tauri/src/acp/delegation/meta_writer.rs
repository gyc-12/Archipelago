...
//! tool-call. The shape written under `meta["archipelago.delegation"]`
...
pub const DELEGATION_META_KEY: &str = "archipelago.delegation";

/// Capability the broker uses to patch `meta["archipelago.delegation"]` on
...
/// Helper to construct the canonical `meta["archipelago.delegation"]` value.
