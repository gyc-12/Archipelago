...
/// to an existing file at build.rs time. The real `archipelago-mcp` sidecar is
...
///   * release.yml         → explicit "Stage archipelago-mcp sidecar" step
...
fn ensure_sidecar_placeholder() {
    ...
    let path = dir.join(format!("archipelago-mcp-{triple}{ext}"));
    ...
    if needs_placeholder {
        ...
        println!(
            "cargo:warning=archipelago-mcp sidecar missing at {}; wrote 0-byte placeholder. \
