...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "flex h-full w-full flex-col overflow-hidden rounded-[18px] bg-popover text-popover-foreground",
        className
      )}
      {...props}
    />
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      <DialogContent
        className="max-w-lg overflow-hidden rounded-[18px] p-0 md:max-w-xl lg:max-w-2xl"
