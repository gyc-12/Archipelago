...
const iconButtonClass =
  "inline-flex h-6 w-6 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-primary/8 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20"
        ...
        {hasCopy && (
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                {isCopied ? (
                  <AppleIcon name="checkCircle" className="size-3.5" />
                ) : (
                  <AppleIcon name="copy" className="size-3.5" />
                )}
              </button>
            </TooltipTrigger>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                aria-label={t("model")}
              >
                <AppleIcon name="thinking" className="size-3.5" />
              </button>
            </TooltipTrigger>
        ...
        {hasUsage && usage && (
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <AppleIcon name="tokens" className="size-3.5" />
              </button>
            </TooltipTrigger>
        ...
        {hasDuration && duration_ms != null && (
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <AppleIcon name="timer" className="size-3.5" />
              </button>
            </TooltipTrigger>
            <TooltipContent side="top">
              <span className="font-mono tabular-nums">
        ...
        {hasJump && (
          <Tooltip>
            <TooltipTrigger asChild>
              ...
              >
                <AppleIcon name="jumpUp" className="size-3.5" />
              </button>
            </TooltipTrigger>
            <TooltipContent side="top">
        ...
        {hasCompletedAt && completedTooltip && (
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                type="button"
                className="inline-flex h-6 cursor-default items-center rounded-full px-2 text-xs tabular-nums text-muted-foreground transition-colors hover:bg-primary/8 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20"
