...
const CodeBlockBody = memo(
  ({
    ...
    return (
      <pre
        className={cn(
          "dark:!bg-[var(--shiki-dark-bg)] dark:!text-[var(--shiki-dark)] m-0 p-4 text-sm leading-relaxed",
          className
        )}
        style={preStyle}
      >
...
export const CodeBlockContainer = ({
  ...
  <div
    className={cn(
      "group relative w-full overflow-hidden rounded-[18px] border border-border/70 bg-card/84 text-foreground shadow-[inset_0_1px_0_rgb(255_255_255_/_50%)] dark:shadow-[inset_0_1px_0_rgb(255_255_255_/_7%)]",
      className
    )}
...
export const CodeBlockHeader = ({
  ...
  <div
    className={cn(
      "flex items-center justify-between border-b border-border/60 bg-muted/45 px-3 py-2 text-muted-foreground text-xs backdrop-blur-xl",
      className
    )}
    {...props}
  >
