...
export function Terminal({
  ...
  return (
    <TerminalContext.Provider value={contextValue}>
      <div
        className={cn(
          "flex flex-col overflow-hidden rounded-[18px] border border-border/70 bg-card/84 text-card-foreground shadow-[inset_0_1px_0_rgb(255_255_255_/_50%)] dark:shadow-[inset_0_1px_0_rgb(255_255_255_/_7%)]",
          className
        )}
        {...props}
      >
...
export function TerminalClearButton({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <AppleIcon name="trash" className="size-3.5" />}
    </Button>
  )
}
...
export function TerminalContent({
  ...
  return (
    <div
      className={cn(
        "max-h-96 overflow-auto bg-background/35 p-4 font-mono text-sm leading-relaxed",
        className
      )}
      ref={containerRef}
      {...props}
