...
export const FileTree = ({
  ...
  return (
    <FileTreeContext.Provider value={contextValue}>
      <div
        className={cn(
          "overflow-hidden rounded-[18px] border border-border/70 bg-card/78 font-mono text-sm shadow-[inset_0_1px_0_rgb(255_255_255_/_45%)] dark:shadow-[inset_0_1px_0_rgb(255_255_255_/_7%)]",
          className
        )}
        role="tree"
        {...props}
