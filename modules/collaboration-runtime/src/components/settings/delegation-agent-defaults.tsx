 ...
 *      chat-side `selectorsCache`. What the user sees here is what archipelago-mcp
...
// collide with any real option id any agent could emit — the Archipelago
// prefix makes a collision implausible.
const DEFAULT_SENTINEL = "__archipelago_default__"
...
const AGENT_TYPES: AgentType[] = ["claude_code", "codex", "open_code", "gemini"]
  ...
  return (
    <div className="space-y-3">
      ...
      <div
        ...
        className="flex flex-wrap gap-1 rounded-[18px] bg-secondary p-1 ring-1 ring-border/60"
      >
