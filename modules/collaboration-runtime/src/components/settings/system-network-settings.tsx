    ...
    <ScrollArea className="h-full">
      <div className="w-full space-y-4 p-3 md:p-4">
        <section className="flex items-start gap-3">
          <AppleIconTile name="system" tone="slate" className="mt-0.5" />
        ...
        <section className="rounded-xl border bg-card p-4 space-y-4">
          <div className="flex items-center gap-2">
            <AppleIconTile
              name={availableUpdate ? "update" : "refresh"}
              tone={lastCheckedAt && !availableUpdate ? "green" : "blue"}
        ...
        <section className="rounded-xl border bg-card p-4 space-y-4">
          <div className="flex items-center gap-2">
            <AppleIconTile name="network" tone="green" />
        ...
        <section className="rounded-xl border bg-card p-4 space-y-4">
          <div className="flex items-center gap-2">
            <AppleIconTile name="language" tone="purple" />
