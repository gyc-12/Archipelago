...
export function AuxPanel() {
  ...
  return (
    <aside className="group/aux-panel flex h-full min-h-0 select-none flex-col overflow-hidden border-r border-border/70 bg-sidebar/95 text-sidebar-foreground backdrop-blur-xl">
      <Tabs
        value={activeTab}
      ...
      >
        <TabsList
          variant="line"
          className="h-10 w-full shrink-0 justify-start border-b border-border/70 bg-sidebar/80 px-3 group-data-horizontal/tabs:h-10"
        >
          <TabsTrigger
            value="session_files"
            title={t("diff")}
