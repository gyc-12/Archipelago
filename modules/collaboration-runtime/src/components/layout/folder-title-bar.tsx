          ...
          isMobile ? (
            <div className="flex min-w-0 items-center gap-2">
              <Button
                ...
                onClick={toggle}
              >
                <AppleIcon name="menu" className="size-4" />
              </Button>
              <NewFolderDropdown />
            ...
            <div className="flex h-8 flex-1 items-center gap-6">
              <div className="flex items-center gap-2">
                <Button
                  variant="ghost"
                  size="icon"
                  className="h-7 w-7 hover:text-foreground/80"
                  onClick={toggle}
                ...
                >
                  <AppleIcon name="panelLeft" className="size-3.5" />
                </Button>
                <NewFolderDropdown />
                <RemoteWorkspaceDropdown />
              </div>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="h-8 w-8">
                    <AppleIcon name="more" className="size-4" />
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end">
                  ...
                  >
                    <AppleIcon name="panelRight" className="size-3.5" />
                  ...
                  <DropdownMenuItem onClick={handleOpenSettings}>
                    <AppleIcon name="system" className="size-3.5" />
            ...
            <div className="flex items-center gap-10">
              <div className="flex items-center gap-2">
                <Button
                  variant="ghost"
                  size="icon"
                  className={`h-7 w-7 hover:text-foreground/80 ${terminalOpen ? "bg-accent" : ""}`}
                  onClick={() => toggleTerminal()}
                  disabled={!activeFolder}
                  title={tTitleBar("withShortcut", {
                ...
                <Button
                  variant="ghost"
                  size="icon"
                  className={`h-7 w-7 hover:text-foreground/80 ${auxPanelOpen ? "bg-accent" : ""}`}
                  onClick={toggleAuxPanel}
                  disabled={!activeFolder}
                  title={tTitleBar("withShortcut", {
                ...
                >
                  <AppleIcon name="search" className="size-3.5" />
                </Button>
                <Button
                  variant="ghost"
                  size="icon"
