    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="flex min-w-0 cursor-default items-center gap-1 text-sm outline-none transition-colors hover:text-foreground/80">
            <AppleIcon name="versionControl" className="size-3 shrink-0" />
            ...
            <AppleIcon name="arrowDown" className="size-3 shrink-0 opacity-50" />
          </button>
        </DropdownMenuTrigger>
