...
export function Sidebar() {
  ...
  return (
    <aside className="@container/sidebar flex h-full min-h-0 flex-col overflow-hidden bg-sidebar text-sidebar-foreground select-none">
      <div className="flex h-11 shrink-0 items-center justify-between gap-2 border-b border-sidebar-border/70 bg-background/65 backdrop-blur-xl pl-4 pr-2">
        <div className="flex min-w-0 items-center gap-4">
          <h2 className="truncate text-[0.875rem] font-semibold text-sidebar-foreground">
            {t("title")}
          </h2>
          <Button
            variant="secondary"
            size="xs"
            className="h-7 shrink-0 px-3 text-xs hover:bg-primary hover:text-primary-foreground focus-visible:bg-primary focus-visible:text-primary-foreground"
        ...
        <div className="flex items-center gap-0.5">
          ...
          >
            <AppleIcon name="crosshair" className="size-3.5" />
          </Button>
          <Button
            variant="ghost"
            size="icon"
          ...
          >
            <AppleIcon
              name={allExpanded ? "minimize" : "maximize"}
              className="size-3.5"
            />
          </Button>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                <AppleIcon name="filter" className="size-3.5" />
              </Button>
            </DropdownMenuTrigger>
