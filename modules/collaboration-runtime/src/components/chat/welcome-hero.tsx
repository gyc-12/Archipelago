...
export function WelcomeTip() {
  ...
  const kbd = (chunks: ReactNode) => (
    <kbd className="mx-0.5 inline-flex items-center rounded border border-border bg-card px-1.5 py-0.5 font-mono text-[10.5px] font-medium text-foreground/80">
      {chunks}
    </kbd>
  )
  ...
  return (
    <div className="flex max-w-full justify-center">
      <div className="flex max-w-full items-start gap-2 rounded-full border border-border/70 bg-card px-4 py-1.5 text-center text-xs text-muted-foreground/90">
