...
import {
  WorkspaceIslandAgentChangedListener,
  WorkspaceIslandGroupDeletedListener,
  WorkspaceOpenFolderListener,
} from "@/components/workspace/workspace-open-folder-listener"
import {
  ResizableHandle,
  ResizablePanel,
  ResizablePanelGroup,
    ...
    <div className="flex flex-1 min-h-0 overflow-hidden bg-background">
      <Sheet open={sidebarRestored && sidebarOpen} onOpenChange={toggleSidebar}>
        <SheetContent
          ...
          className="w-[85%] max-w-[360px] border-r border-border/70 bg-background/95 p-0 backdrop-blur-xl"
        >
      ...
      <Sheet open={auxRestored && auxOpen} onOpenChange={toggleAux}>
        <SheetContent
          side="right"
          showCloseButton={false}
          className="w-[85%] max-w-[360px] border-l border-border/70 bg-background/95 p-0 backdrop-blur-xl"
        >
      ...
      <Sheet open={terminalOpen} onOpenChange={toggleTerminal}>
        <SheetContent
          side="bottom"
          showCloseButton={false}
          className="!h-[70vh] border-t border-border/70 bg-background/95 p-0 backdrop-blur-xl"
        >
