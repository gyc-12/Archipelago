const EXACT_TOOL_NAME_ALIASES: Record<string, string> = {
  ...
  // Archipelago multi-agent delegation MCP tool (varies by server prefix)
  delegate_to_agent: "delegate_to_agent",
  "mcp__archipelago-delegate__delegate_to_agent": "delegate_to_agent",
  mcp__archipelago_delegate__delegate_to_agent: "delegate_to_agent",
  // OpenCode
  delegate_task: "task",
