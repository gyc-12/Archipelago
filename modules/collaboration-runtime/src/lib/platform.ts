...
/**
 * Reveal a file/directory in the system file manager.
 * Uses Tauri opener in a local Tauri webview and the embedded web server
 * command in packaged web-runtime mode.
 */
export async function revealItemInDir(path: string): Promise<void> {
  ...
  await getTransport().call("reveal_path_in_file_manager", { path })
}
