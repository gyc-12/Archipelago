...
export const LANGUAGE_SETTINGS_STORAGE_KEY = "archipelago.system_language_settings"
export const LANGUAGE_MODE_COOKIE_KEY = "archipelago.language_mode"
export const LANGUAGE_COOKIE_KEY = "archipelago.locale"
