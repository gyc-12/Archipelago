...
import { buildArchipelagoWebSocketProtocols } from "./ws-auth"
import { getArchipelagoToken, redirectToArchipelagoLogin } from "./web-auth"
...
const getToken = getArchipelagoToken
...
export class WebTransport implements Transport {
  ...
  private connectWs() {
    ...
    this.ws = new WebSocket(wsUrl, buildArchipelagoWebSocketProtocols(token))
