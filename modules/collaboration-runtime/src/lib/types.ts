...
export type GroupCollaborationMode = "mention" | "auto"
...
export type ContentBlock =
  ...
  | {
       ...
       * `meta["archipelago.delegation"] = { status, child_connection_id,
...
export interface GroupChatWithAgents {
  group: GroupChatInfo
...
export interface GroupCollaborationMemberInfo {
  agent_id: number
  agent_type: AgentType
  role: string
  working_dir: string
 ...
 * the Archipelago runtime. Experts live in a central store at `~/.archipelago/skills/`
